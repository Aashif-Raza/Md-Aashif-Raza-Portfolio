...
using use = useUsing("use")`,
  ...
  [SkillNames.VITE]: {
    ...
    name: "vite",
    label: "Vite",
    shortDescription: "lightning fast build tool, no cap! ⚡🔥",
    color: "#646cff",
  ...
  [SkillNames.SQL]: {
    ...
    name: "sql",
    label: "SQL",
    shortDescription: "querying data like a boss, SELECT * FROM skills! 📊🚀",
    color: "#336791",
  ...
  [SkillNames.NETLIFY]: {
    ...
    label: "Netlify",
    shortDescription:
      "deploying with the energy of a thousand suns! 🌟🚀",
    color: "#00c7b7",
